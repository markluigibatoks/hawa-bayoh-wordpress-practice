...
<head>
  ...
  <!--[if IE]><meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"><![endif]-->
	...
	<link rel="stylesheet" href="<?php bloginfo('template_url');?>/css/skitter.styles.css" type="text/css" media="all"  />
	<link rel="stylesheet" href="<?php bloginfo('template_url');?>/css/animations.min.css">

	<?php if ( is_user_logged_in() ) { ?>
		<style>
			.page_nav {top: 32px;}
			.header_info { top: 32px; }
			@media only screen and (max-width : 800px) { nav.toggle_right_style{top:32px;} }
			@media only screen and (max-width : 782px) { nav.toggle_right_style{top:46px;} }
		</style>
	<?php }?>
	<?php wp_head(); ?>
</head>
